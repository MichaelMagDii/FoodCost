        ...
        { 
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    string Values = "'" + dt.Rows[i]["Code"] + "','" + transfer_No.Text + "','" + dt.Rows[i]["Qty"] + "','" + dt.Rows[i]["Unit"] + "','" + i + "','" + dt.Rows[i][7] + "','" + NetCost + "','" + dt.Rows[i][To_Kitchen.Text + " Qty"] + "','" + dt.Rows[i][To_Kitchen.Text + " Unit Cost"] + "','" + dt.Rows[i][From_Kitchen.Text + " Qty"] + "','" + dt.Rows[i][From_Kitchen.Text + " Unit Cost"] + "'";
